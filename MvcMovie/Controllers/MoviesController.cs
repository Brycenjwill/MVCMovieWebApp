...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(DateTime MovieReleaseDate, string movieGenre, string searchString)
        {
            ...
            if (MovieReleaseDate != default(DateTime)) //If movie date time is set
            {
        ...
        {
                    ViewBag.Genres = new List<SelectListItem> //Genres
            {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Rating,ReleaseDate,Genre,Price,ImageName")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Rating,ReleaseDate,Genre,Price,ImageName")] Movie movie)
        {
            ViewBag.Genres = new List<SelectListItem>
        {
                new SelectListItem { Value = "Documentary", Text = "Documentary" },
